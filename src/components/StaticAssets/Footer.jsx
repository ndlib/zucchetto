...
class Footer extends Component {
  render() {
    return (
      <footer>
        <div className="row">
          <div className="col-sm-3 compare">
            { this.props.showCompareButton ? (<CompareButton/>) : '' }
            { this.props.showBackToSearchButton ? (<BackToSearchButton/>) : '' }
          </div>
          <div className="col-sm-3">
            <a href="https://docs.google.com/a/nd.edu/forms/d/1yCnSjl4nBCJYmw70_S2VfVx1LzgNQ-kmroOqapq6i0Q/viewform" target="_blank">Project Feedback</a> |
          </div>

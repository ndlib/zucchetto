  ...
  render() {
    return (
      <div>
        ...
        <h2>Documents</h2>
        <div className="partners-c">
            <Link to='http://w2.vatican.va/content/vatican/en.html' target='_blank'><img alt="Libreria Editrice Vaticana" src="/resources/images/partners/lev.png" /></Link>
            <Link to='http://www.coe.int/en/web/conventions/' target='_blank'><img alt="Council of Europe" src="/resources/images/partners/coe.png" /></Link>
            <Link to='http://www.un.org/en/index.html' target='_blank'><img alt="United Nations" src="/resources/images/partners/un.png" /></Link>

    ...
    return (
      <div>
        ...
        <ul>
         ...
         <li> <strong><Link to='https://jesuits.georgetown.edu/members/hollenbach' target='_blank'>Hollenbach, David     </Link></strong>  <br/><em>Pedro Arrupe Distinguished Research Professor  <br/>      Walsh School of Foreign Service, Georgetown University </em>  </li>
